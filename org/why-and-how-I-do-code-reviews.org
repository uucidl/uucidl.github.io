...
There are broad and well known reasons for reviews such as catching
unwanted errors or enforcing homogeneity through the removal of a
creator's bias about their own work. In other domains and for similar
reason writers have editors and airplanes are flown with a
...
help form[fn:ConceptFormation] and share knowledge and concepts of a
system.
...
Beyond communication and double-checking, I want code-reviews to help
ensure that in the long run parts of a software can be understood and
changed. (To preserve this, I prefer reviews starting with little
